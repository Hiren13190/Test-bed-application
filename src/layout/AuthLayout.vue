  ...
  <div class="main-content bg-default">
    ...
    >
      <router-link slot="brand" class="navbar-brand" to="/">
        <img src="img/theme/Innovate5G.webp" />
      </router-link>
    ...
    <!-- Header -->
    <div class="header padding-section">
      <div class="container">
        <div class="header-body text-center mt-10">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">Welcome!</h1>
              <p
                class="text-lead text-white"
              >Test your application on our network. We will provide all the metrics needed to certify your 5G application.</p>
            </div>
          </div>
        </div>
      </div>
